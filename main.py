...
def analyze_audio(input_audio_path):
    ...
    if mfcc_features is not None:
        ...
        if prediction[0] == 0:
            print("😻Hehee.. Giọng Thiệt Nè 😻")
        else:
            print("🙀Ôiiii....Giọng Giả Kìa Cẩn Thận 🙀")
    else:
        print("Error: Unable to process the input audio.")

def main():
    genuine_dir = r"D:\DeepFake-Audio-Detection-MFCC-main\DeepFake-Audio-Detection-MFCC-main\\real_audio"
    deepfake_dir = r"D:\DeepFake-Audio-Detection-MFCC-main\DeepFake-Audio-Detection-MFCC-main\\deepfake_audio"
